    ...
    <div className="space-y-6 pb-12 font-sans" id="user-management-root">
      ...
      <div className="flex flex-wrap items-center justify-between gap-4 p-6 rounded-2xl bg-white border border-slate-200 shadow-xs" id="users-header">
        ...
        <div className="flex items-center gap-3">
          ...
          {/* Reset Clean Slate for Super Admin */}
          {isSuperAdmin && (
            <button
          ...
          <div className="bg-white rounded-2xl max-w-md w-full shadow-2xl border border-slate-200 p-6 animate-in fade-in zoom-in-95">
            <div className="flex items-center gap-3 text-red-600 mb-3">
              ...
              <h3 className="font-black text-base text-slate-900">
                Confirm System Clean Slate
              </h3>
            </div>

            <p className="text-xs text-slate-600 leading-relaxed mb-4">
              This will wipe the entire database clean, resetting the system to <strong>0 parcels</strong>, <strong>0 branches</strong>, and <strong>0 expenses</strong>, preserving only the Central System Super Admin account.
            </p>

            <div className="p-3 bg-amber-50 border border-amber-200 rounded-xl text-amber-900 text-xs mb-5">
              <p className="font-bold mb-0.5">Ready for client handover:</p>
              <p className="text-[11px] text-amber-800">
                The client can start from zero and add their own branches, parcels, and accounts.
              </p>
            </div>
            ...
            <div className="flex items-center justify-end gap-2">
              ...
              <button
                ...
                className="px-4 py-2.5 rounded-xl bg-red-600 hover:bg-red-700 text-white text-xs font-bold shadow-md shadow-red-600/20 transition-all cursor-pointer flex items-center gap-1.5"
              >
                {isResetting ? (
                  <>
